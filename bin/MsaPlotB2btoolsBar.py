...
#splitting is still broken

'''
folder      = './' #results/CK_00001561_null_2023_03_03_11_25_27/'

msa         = folder + 'myco_groel_sel_filtered_clustered_checked.aaa' #'CK_00001561_null_filtered.fasta.aaa'
predictions = folder + 'b2b_msa_results_myco_groel_sel_filtered_clustered_checked.json' #'b2b_msa_results_CK_00001561_null_filtered.fasta.json'
stats       = folder +  'b2b_msa_stats_myco_groel_sel_filtered_clustered_checked.json'#'b2b_msa_stats_CK_00001561_null_filtered.fasta.json'

selected_proteins   =  ['human','E_coli','2695420338_groEL1_M_tuberculosis']#['Syn_WH5701_01905_273568','VIII_1_CK_Syn_RS9917_06430'] #['Q8NTX0']#
...
#if aa input > aligned w clustal > fasta, not fasta2line format!
...
def plot_biophysical_msa(stats, suboccupancy, selected_prot , biophys_data, label, res_num):
    ...
    plt.savefig( msa_baseName + '_msa_' + plot_name + '.png', dpi=500)
