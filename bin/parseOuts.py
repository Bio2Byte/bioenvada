...
etem8 =  glob.glob('ete*/pamlwd/*M8*/rst')[0] #'pamlwd/M8.CK_00001561_mini_filtered_clustered_NT_checked.afasta/rst'
...
def find_best_branch(csubstbranchfiles,dataname):
    ...
    bestdf.to_csv(dataname+'summary_of_branch_combination.csv')
